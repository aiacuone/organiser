	...
	<div class="stack gap-4">
		...
		>
			<div class="w-full stack gap-3">
				<div class="w-full stack gap-4 text-xs sm:text-sm md:text-md">
					<NoteListItem subject="first subject">
						...
						ultrices eu. Praesent sit amet nisl volutpat quam fermentum suscipit. Aenean sodales
						ante sed enim porta, sit amet viverra nulla porta. Curabitur sodales pharetra.
					</NoteListItem>
					<NoteListItem subject="second subject">
						Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent vitae enim ut mi
						lobortis commodo vitae ut justo. Etiam rutrum ligula justo, sit amet elementum sapien
						ultrices eu. Praesent sit amet nisl volutpat quam fermentum suscipit. Aenean sodales
						ante sed enim porta, sit amet viverra nulla porta. Curabitur sodales pharetra.
